...
LDLIBSOPTIONS=/usr/lib/librrd.a -lpcap

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/pcaprrd.exe

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/pcaprrd.exe: /usr/lib/librrd.a
...
${OBJECTDIR}/RRD.o: RRD.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/RRD.o RRD.cpp
...
${OBJECTDIR}/PacketLogger.o: PacketLogger.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/PacketLogger.o PacketLogger.cpp
